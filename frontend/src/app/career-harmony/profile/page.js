...
import { User, Mail, Phone, MapPin, FileText, Upload, Camera, Edit3, Save, Check, Star, Briefcase, GraduationCap, Award, Heart, Zap } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-green-200 p-6">
              ...
              <button className="w-full bg-amber-100 text-green-700 border border-green-300 py-3 rounded-lg font-medium hover:bg-amber-200 transition-all flex items-center justify-center">
              ...
              <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-green-200 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {profileData.skills.map((skill, index) => (
                    <span key={index} className="bg-amber-50 text-green-800 px-3 py-1 rounded-full text-sm border border-green-200">
                      {skill}
                    </span>
                  ))}
                </div>
                
                <button className="w-full bg-amber-100 text-green-700 border border-green-300 py-2 rounded-lg font-medium hover:bg-amber-200 transition-all text-sm">
                  Add Skills
                </button>
              </div>
            </div>
