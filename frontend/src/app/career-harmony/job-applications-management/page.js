...
import { Search, Filter, MoreVertical, Eye, Calendar, Mail, Phone, User, MapPin, Clock, Building2, Briefcase, GraduationCap, Star, ChevronDown, ArrowLeft, Bell, Settings, FileText, Download } from 'lucide-react';
...
export default function JobApplicationsManagement() {
  ...
  const getStatusBadge = (status) => {
    const statusConfig = {
      unreviewed: { bg: 'bg-amber-100', text: 'text-amber-800', label: 'Unreviewed' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-amber-50 to-green-100">
      <CareerHarmonyHeader currentPage="applications" />
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-xl shadow-lg border border-green-200 p-4 sm:p-6 mb-8">
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between space-y-4 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:ml-6">
              <button className="bg-amber-100 text-green-700 border border-green-300 px-4 py-2 rounded-lg font-medium hover:bg-amber-200 transition-all text-center">
                Edit Job
              </button>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3">
                      ...
                      <button className="bg-amber-100 text-green-700 border border-green-300 px-3 py-2 rounded-lg font-medium hover:bg-amber-200 transition-all flex items-center justify-center text-sm">
